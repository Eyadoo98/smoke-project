...
{{--    <div class="flex">--}}
{{--        <div class="w-full md:w-1/2">1</div>--}}
{{--        <div class="w-full md:w-1/2">2</div>--}}
{{--    </div>--}}
...
{{--                <source src="{{asset('assets/Videos/smoke.mp4')}}" type="video/mp4">--}}
{{--                <source src="{{asset('assets/Videos/smoke.mp4')}}" type="video/ogg">--}}
...
{{--        document.getElementById("loginNavbar").click();--}}
{{--    });--}}
{{--</script>--}}
</body>
</html>
