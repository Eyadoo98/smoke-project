{{--            Section Plan--}}
    <div class="w-full mx-auto bg-white px-5 py-10 text-gray-600 mb-10" id="pricing-section">
        ...
        <div class="max-w-4xl mx-auto md:flex">
            <div class="w-full md:w-1/3 md:max-w-none bg-white px-8 md:px-10 py-8 md:py-10 mb-3 mx-auto md:my-6 rounded-md shadow-lg shadow-gray-600 md:flex md:flex-col">
                ...
                <div class="w-full">
                    <button class="font-bold bg-gray-600 hover:bg-yellow-500 text-white rounded-md px-10 py-2 transition-colors w-full">
                        Subscribe Now
                    </button>
                </div>
            </div>
            <div class="w-full md:w-1/3 md:max-w-none bg-white px-8 md:px-10 py-8 md:py-10 mb-3 mx-auto md:-mx-3 md:mb-0 rounded-md shadow-lg shadow-gray-600 md:relative  md:flex md:flex-col">
{{--            md:z-50--}}
                <div class="w-full flex-grow">
                ...
                <div class="w-full">
                    <button class="font-bold bg-yellow-600 hover:bg-gray-700 text-white rounded-md px-10 py-2 transition-colors w-full bg-yellow-500">
                        Subscribe Now
                    </button>
                </div>
            </div>
