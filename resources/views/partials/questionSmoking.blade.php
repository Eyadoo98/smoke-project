        ...
        <div class="col-md-8" style="text-align: right;">
            ...
            <div class="card">
                ...
                <div style="padding: 20px;">
                    ...
                    @error('startSmokingAge') <span class="error"
                                                    style="color: red !important;">{{ $message }}</span> @enderror
                    ...
                    <div>
                        ...
                        @foreach($typeCigarette as $type)
                            ...
                            @if(isset($checkboxTypeCigarette[$type->id]) && !empty($checkboxTypeCigarette[$type->id]))
